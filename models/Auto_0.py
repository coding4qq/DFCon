...
from layers.gs_embedding import gs_embedding
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.gs_emb = gs_embedding(configs)
        self.enc_embedding = nn.Linear(configs.enc_in+configs.layer_size, self.hidden_dims)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        enc_out = self.gs_emb(long_x, x_mark_enc)

...
if __name__ == '__main__':
    ...
    parser.add_argument('--save', type=int, default=0, help='Save predictions')
    ...
    # DeepTime
    parser.add_argument('--datetime_feats', type=int, default=4,
                        help='datetime_feats')
    parser.add_argument('--layer_size', type=int, default=128,
                        help='deeptime_layer')
    parser.add_argument('--inr_layers', type=int, default=3,
                        help='inr layers')
    parser.add_argument('--n_fourier_feats', type=int, default=8,
                        help='fourier_feats')
    parser.add_argument('--scales', type=float, nargs='+', default=[0.01, 0.1, 1, 5],
                        help='scales')
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='global and local adaptive weight')
    ...
    parser.add_argument('--dev', type=str, default='60', help='training device')

...
from layers.Frelosses import DominantLoss
            ...
            for i, (timeindex, batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.AutoCon:
                    ...
                    if self.args.model == 'DeepTime':
                        ...
                        outputs, repr, _, _ = self.model(batch_x, batch_x_mark, dec_inp, batch_y_mark)
                else:
                    if self.args.model == 'DeepTime':
                        outputs, repr = self.model(batch_x, batch_x_mark, batch_y_mark)
                    else:
            ...
            for i, (timeindex, batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if not self.args.AutoCon:
                    ...
                    if self.args.model == 'DeepTime':
                        ...
                        outputs, repr_t, repr_s, pos = self.model(batch_x, batch_x_mark, dec_inp, batch_y_mark)
                ...
                local_loss, global_loss = self.FreLoss(repr_t, repr_s, pos, global_pos_labels)
                ...
                FreLoss = (self.args.alpha * (local_loss) + self.args.alpha * (1 - global_loss))
